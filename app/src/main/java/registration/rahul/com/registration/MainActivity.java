...
public class MainActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        innerScroll = (LinearLayout) findViewById(R.id.innerscroll);
        collapsingToolbarLayout = (CollapsingToolbarLayout)findViewById(R.id.collapsing_toolbar);
        paddingLayout = (LinearLayout)findViewById(R.id.padding);
        ...
        activityRootView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                ViewGroup.LayoutParams parms = innerScroll.getLayoutParams();
                parms.height = (int)(activityRootView.getHeight()*.7);
                innerScroll.setLayoutParams(parms);

                parms = paddingLayout.getLayoutParams();
                parms.height = activityRootView.getHeight()/2;
                paddingLayout.setLayoutParams(parms);
            }
        });
